    ...
    <article className={clsx('max-w-80 relative')}>
      <a 
        className={clsx('group block pb-2 hover:bg-zinc-100 dark:hover:bg-zinc-800 focus-within:bg-zinc-100 focus-within:dark:bg-zinc-800',
                       'outline outline-1 outline-transparent hover:outline-zinc-900 hover:dark:outline-zinc-100',
                       'focus-within:outline-zinc-900 focus-within:dark:outline-zinc-100')}
        href={`/post/${href}`}
      >
        ...
        <div className='px-2'>
          ...
          <header className='text-xl group-hover:underline'>{children}</header>
        </div>
      </a> 
    </article>
  )
